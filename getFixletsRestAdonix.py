...
myRequest = baseurl+'query?relevance=(name of fixlet of it) of results from (bes fixlets whose (display name of site of it contains "Patches for RHEL 5" and fixlet flag of it = true)) whose (exists last became relevant of it and relevant flag of it = false) of bes computers whose (name of it as lowercase contains "adonix")'
...
file = open('/tmp/fixedFixlets.txt', 'w')
file.write(r.text)
file.close()
